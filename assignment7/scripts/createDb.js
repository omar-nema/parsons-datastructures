...
var thisQuery =
  'CREATE TABLE meetingTimes (id int GENERATED BY DEFAULT AS IDENTITY, groupId int, day varchar(100), specialInterest varchar(100), startTime varchar(100), endTime varchar(100) );';
